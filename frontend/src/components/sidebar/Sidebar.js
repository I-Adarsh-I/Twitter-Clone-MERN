        ...
        <div className="card-body d-flex justify-content-between align-items-center gap-2 py-2">
          <div className="name-n-avatar d-flex align-items-center gap-3">
            <div className="avatar rounded-pill overflow-hidden">
              <img src="https://i.pinimg.com/736x/c0/74/9b/c0749b7cc401421662ae901ec8f9f660.jpg" alt="profile" className="w-100 "/>
            </div>
          ...
          <div className="more-options rounded-pill d-flex align-items-center justify-content-center m-0" role="button">
